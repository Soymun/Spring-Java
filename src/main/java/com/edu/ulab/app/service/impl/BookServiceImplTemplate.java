...
import com.edu.ulab.app.SQL.BookSQL;
...
public class BookServiceImplTemplate implements BookService {
        ...
        jdbcTemplate.update(
                connection -> {
                    PreparedStatement ps =
                            connection.prepareStatement(BookSQL.INSERT_SQL, new String[]{"id"});
    ...
    public BookDto updateBook(BookDto bookDto) {
        ...
        jdbcTemplate.update(
                connection -> {
                    PreparedStatement ps =
                            connection.prepareStatement(BookSQL.UPDATE_SQL, new String[]{"id"});
                    ps.setString(1, bookDto.getTitle());
                    ps.setString(2, bookDto.getAuthor());
                    ps.setLong(3, bookDto.getPageCount());
                    ps.setLong(4, bookDto.getUserId());
    ...
    public BookDto getBookById(Long id) {
        ...
        BookDto bookDto = jdbcTemplate.query(con -> {
            PreparedStatement preparedStatement = con.prepareStatement(BookSQL.SELECT_SQL, new String[]{"id"});
    ...
    public List<BookDto> getBookByUserId(Long id) {
        ...
        return jdbcTemplate.query(con -> {
            PreparedStatement preparedStatement = con.prepareStatement(BookSQL.SELECT_USER_ID_SQL, new String[]{"id"});
            preparedStatement.setLong(1, id);
            return preparedStatement;
        }, new BookRowMapper());
    }
    ...
    public void deleteBookById(Long id) {
        ...
        jdbcTemplate.update(
                connection -> {
                    PreparedStatement ps =
                            connection.prepareStatement(BookSQL.DELETE_SQL, new String[]{"id"});
                    ps.setLong(1, id);
                    return ps;
                });
