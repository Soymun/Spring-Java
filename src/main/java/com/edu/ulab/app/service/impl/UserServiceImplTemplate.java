...
import com.edu.ulab.app.SQL.UserSQL;
...
public class UserServiceImplTemplate implements UserService {
    ...
    public UserDto createUser(UserDto userDto) {
        ...
        jdbcTemplate.update(
                connection -> {
                    PreparedStatement ps = connection.prepareStatement(UserSQL.INSERT_SQL, new String[]{"id"});
        ...
        jdbcTemplate.update(
                connection -> {
                    PreparedStatement ps =
                            connection.prepareStatement(UserSQL.UPDATE_SQL, new String[]{"id"});
                    ps.setString(1, userDto.getFullName());
                    ps.setString(2, userDto.getTitle());
                    ps.setLong(3, userDto.getAge());
    ...
    public UserDto getUserById(Long id) {
        ...
        UserDto userDto = jdbcTemplate.query(con -> {
            PreparedStatement preparedStatement = con.prepareStatement(UserSQL.SELECT_SQL, new String[]{"id"});
    ...
    public void deleteUserById(Long id) {
        ...
        jdbcTemplate.update(
                connection -> {
                    PreparedStatement ps =
                            connection.prepareStatement(UserSQL.DELETE_SQL, new String[]{"id"});
                    ps.setLong(1, id);
                    return ps;
                });
